...
class WatchCard extends React.Component{
    ...
    render(){
        return(
            <div className={classes.mainContainer}>
                ...
                <div className={classes.playerWrapper} >
                    <iframe  className={classes.video} src={`https://player.vimeo.com/video/${this.state.videoData.vimeoId}`}></iframe> 
                     ...
                     <FontAwesomeIcon className={ this.setState.isLiked? classes.icon :classes.activIcon } icon={faHeart} />
                     <FontAwesomeIcon className={classes.icon} icon={faCommentAlt} />
                     <FontAwesomeIcon className={this.setState.isSaved ? classes.icon : classes.activIcon} icon={faBookmark} />  
                     </div>
                     </div>
               </div>
            ...
            <Link to={`/video/watch/${this.props.match.params.videoId}`}> 
